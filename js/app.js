...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (service_section) {
    ...
    document
      .querySelector(".ai_product_div h2")
      .addEventListener("mouseenter", () => showCard(aiCard));
    document
      .querySelector(".grc_product_div h2")
      .addEventListener("mouseenter", () => showCard(grcCard));
    document
      .querySelector(".web_product_div h2")
...
var ai_driver_web_service_partial = document.getElementById(
  "ai_driver_web_service_partial"
);
